 ...
 */
var ErrorServerResponse = function (_Error) {
  _inherits(ErrorServerResponse, _Error);
  ...
  function ErrorServerResponse(statusCode, statusText) {
    ...
    _classCallCheck(this, ErrorServerResponse);

    var _this = _possibleConstructorReturn(this, (ErrorServerResponse.__proto__ || Object.getPrototypeOf(ErrorServerResponse)).call(this, message));
    ...
    if (Error.captureStackTrace) {
      Error.captureStackTrace(_this, ErrorServerResponse);
    } else {
